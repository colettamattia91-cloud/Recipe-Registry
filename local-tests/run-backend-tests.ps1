...
$activeAllSpecs = @(
    ...
    "detail_craft_profit_spec.lua",
    "detail_item_cache_rerender_spec.lua",
    "detail_request_button_instance_spec.lua",
    ...
    "filter_profitable_only_spec.lua",
    ...
    "market_vendor_scan_spec.lua",
    "missing_recipes_spec.lua",
    "missing_tab_view_spec.lua",
    "metadata_normalize_key_spec.lua",
    "metadata_override_merge_spec.lua",
    "metadata_profession_hint_spec.lua",
    ...
    "recipe_source_detail_spec.lua",
    "scan_ambiguous_dual_key_spec.lua",
