...
local FORBIDDEN = {
    ...
    { name = "publishedGlobalFingerprint token", pattern = "publishedGlobalFingerprint" },
    { name = "committedGlobalFingerprint token", pattern = "committedGlobalFingerprint" },
    { name = "currentGlobalFingerprint token", pattern = "currentGlobalFingerprint" },
    { name = "snapshot codec token", pattern = "SNAP_CODEC" },
    { name = "snapCodec token", pattern = "snapCodec" },
    { name = "canSendSnap token", pattern = "%f[%w]canSendSnap%f[%W]" },
    { name = "canReceiveReq token", pattern = "%f[%w]canReceiveReq%f[%W]" },
    { name = "chunkWindow token", pattern = "%f[%w]chunkWindow%f[%W]" },
    { name = "SendNextLowPriorityChunk", pattern = "%f[%w]SendNextLowPriorityChunk%f[%W]" },
    { name = "ScheduleOutboundPump", pattern = "%f[%w]ScheduleOutboundPump%f[%W]" },
